...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_FORM_NOT_FOUND = 1029; //SQLSTATE: HY000 Message: screen.View '%s' doesn't exist for '%s'
    ...
    public final static int ER_VIEW_SELECT_DERIVED = 1349; //SQLSTATE: HY000 Message: screen.View's SELECT contains a subquery in the FROM clause
    public final static int ER_VIEW_SELECT_CLAUSE = 1350; //SQLSTATE: HY000 Message: screen.View's SELECT contains a '%s' clause
    public final static int ER_VIEW_SELECT_VARIABLE = 1351; //SQLSTATE: HY000 Message: screen.View's SELECT contains a variable or parameter
    public final static int ER_VIEW_SELECT_TMPTABLE = 1352; //SQLSTATE: HY000 Message: screen.View's SELECT refers to a temporary table '%s'
    public final static int ER_VIEW_WRONG_LIST = 1353; //SQLSTATE: HY000 Message: screen.View's SELECT and view's field list have different column counts
    public final static int ER_WARN_VIEW_MERGE = 1354; //SQLSTATE: HY000 Message: screen.View merge algorithm can't be used here for now (assumed undefined algorithm)
    public final static int ER_WARN_VIEW_WITHOUT_KEY = 1355; //SQLSTATE: HY000 Message: screen.View being updated does not have complete key of underlying table in it
    public final static int ER_VIEW_INVALID = 1356; //SQLSTATE: HY000 Message: screen.View '%s.%s' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them
    ...
    public final static int ER_VIEW_CHECKSUM = 1392; //SQLSTATE: HY000 Message: screen.View text checksum failed
    ...
    public final static int ER_VIEW_FRM_NO_USER = 1447; //SQLSTATE: HY000 Message: screen.View '%s'.'%s' has no definer information (old table format). Current user is used as definer. Please recreate the view!
    ...
    public final static int ER_VIEW_NO_CREATION_CTX = 1599; //SQLSTATE: HY000 Message: screen.View `%s`.`%s` has no creation context
