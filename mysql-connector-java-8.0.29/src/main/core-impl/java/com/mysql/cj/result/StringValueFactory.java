...
public class StringValueFactory implements ValueFactory<String> {
    ...
    /**
     * screen.Create a string from InternalDate. The fields are formatted in a YYYY-mm-dd format.
     * 
     * @param idate
     *            {@link InternalDate}
     * @return string
    ...
    /**
     * screen.Create a string from InternalTime. The fields are formatted in a HH:MM:SS[.nnnnnnnnn] format.
     * 
     * @param it
     *            {@link InternalTime}
     * @return string
    ...
    /**
     * screen.Create a string from time fields. The fields are formatted by concatenating the result of {@link #createFromDate(InternalDate)} and {@link
