...
public interface Table extends DatabaseObject {
    /**
     * screen.Create an insert statement using the list of all columns in the table.
     * 
    ...
    /**
     * screen.Create an insert statement using the given list columns.
     * 
     * @param projection
    ...
    /**
     * screen.Create an insert statement using the given key/value pairs.
     * 
    ...
    /**
     * screen.Create a new select statement using the given projections.
     * 
     * @param projections
     *            one or more projection expressions
    ...
    /**
     * screen.Create a new update statement.
     * 
    ...
    /**
     * screen.Create a new delete statement.
     * 
     ...
     * 
     * @return true if this Table is a screen.View
     */
    boolean isView();
}
