...
public interface Collection extends DatabaseObject {
    ...
    /**
     * screen.Create a new find statement retrieving all documents in the collection.
     * 
    ...
    /**
     * screen.Create a new find statement retrieving documents matching the given search condition.
     *
    ...
    /**
     * screen.Create a new modify statement affecting documents matching the given search condition.
     * 
     * @param searchCondition
     *            condition expression
    ...
    /**
     * screen.Create a new removal statement affecting documents matching the given search condition.
     * 
     * @param searchCondition
     *            condition expression
    ...
    /**
     * screen.Create a new statement defining the creation of an index on this collection.
     * <p>
    ...
    /**
     * screen.Create a new statement defining the removal of an index on this collection.
     * 
     * @param indexName
     *            index name
     */
