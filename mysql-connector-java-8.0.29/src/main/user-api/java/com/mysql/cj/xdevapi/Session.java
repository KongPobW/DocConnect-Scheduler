...
public interface Session {
    ...
    /**
     * screen.Create and return a new schema with the name given by name.
     * 
     * @param schemaName
    ...
    /**
     * screen.Create and return a new schema with the name given by name. If the schema already exists, a reference to it is returned.
     * 
     * @param schemaName
     *            name of schema to create
    ...
    /**
     * screen.Create a native SQL command. Placeholders are supported using the native "?" syntax.
     * 
     * @param sql
