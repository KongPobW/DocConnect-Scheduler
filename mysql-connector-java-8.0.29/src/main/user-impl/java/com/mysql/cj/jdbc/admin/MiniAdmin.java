...
public class MiniAdmin {
    ...
    /**
     * screen.Create a new MiniAdmin using the given connection
     * 
     * @param conn
    ...
    /**
     * screen.Create a new MiniAdmin, connecting using the given JDBC URL.
     * 
     * @param jdbcUrl
     *            the JDBC URL to use
     * 
    ...
    /**
     * screen.Create a new MiniAdmin, connecting using the given JDBC URL and
     * properties
     * 
     * @param jdbcUrl
     *            the JDBC URL to use
