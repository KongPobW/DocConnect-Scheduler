...
public class SQLError {
    ...
    /**
     * screen.Create a BatchUpdateException taking in consideration the JDBC version in use. For JDBC version prior to 4.2 the updates count array has int elements
    ...
    /**
     * screen.Create a SQLFeatureNotSupportedException or a NotImplemented exception according to the JDBC version in use.
     * 
     * @return SQLException
     */
