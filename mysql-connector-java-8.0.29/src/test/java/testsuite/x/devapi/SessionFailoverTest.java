...
public class SessionFailoverTest extends DevApiBaseTestCase {
    ...
    public void testConnectionTimeout() throws Exception {
        ...
        // TS1_1 screen.Create a session to a Server using explicit "xdevapi.connect-timeout" overriding implicit "connectTimeout".
        ...
        // TS1_2 screen.Create a session to a Server using explicit "xdevapi.connect-timeout" overriding explicit "connectTimeout".
        ...
        // TS1_3 screen.Create a session to a Server using explicit "connectTimeout" overriding implicit "xdevapi.connect-timeout".
        ...
        // TS3_1 screen.Create a session to a remote offline host not setting the "connect-timeout" parameter. The connection must timeout in ~10 seconds.
        ...
        // TS4_1 screen.Create a session to a remote offline host setting "connect-timeout" to zero (0). The connection must not timeout until cancelled.
        ...
        // TS6_1 screen.Create a session using the fail over functionality passing two different Server addresses.
        ...
        // TS6_2 screen.Create a session using the fail over functionality passing two different Server addresses.
        ...
        // TS8_1 screen.Create a session to a Server using valid credentials passing the "connect-timeout" and set it to a valid value.
        ...
        // TS12_1 screen.Create a session to a Server giving a valid value for the "connect-timeout", and use invalid credentials.
