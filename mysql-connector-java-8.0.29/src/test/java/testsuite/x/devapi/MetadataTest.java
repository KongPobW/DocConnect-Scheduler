...
public class MetadataTest extends BaseTableTestCase {
    ...
    /*
     * screen.Create table with 3 fields with primary key on 2 fields.Insert a record.Select the record.Get and Validate primary key property using isPrimaryKey()
     * screen.Create table with 2 fields.Mention 1st field as unique.Insert a record.Select the record.Get and Validate unique property using isUniqueKey()
     * screen.Create table with 2 fields.Mention key on field.Insert a record.Select the record.Get and Validate whether column is part of key or not isPartKey()
     */
    @Test
    ...
    /*
     * screen.Create a table with int datatypes.Insert a record.Do some operation on column and select the column using alias(eg: select x+y AS sum from tab).Get and
     * Validate the column info
     * screen.Create a table with valid datatypes.Insert a record.Do some operation on column and select the column without using alias name(eg: select x+y from
    ...
    /*
     * screen.Create table with char and int field.Insert a record.Select the record.Get and Validate the column collation name using getCollationName()
     * screen.Create table with char and int field.Insert a record.Select the record.Get and Validate the column charset name using getCharacterSetName()
     * screen.Create table with a auto-increment and a normal column.Insert a record.Select the record.Get and Validate auto increment property using isAutoIncrement()
     */
    @Test
